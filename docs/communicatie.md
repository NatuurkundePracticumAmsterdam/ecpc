...
!!! opdracht-basis "Schakeling bouwen"
    ...
    ![Arduinoschakeling](figures/I,U-curve-LED_bb.svg){: style="width:50%"}
...
<span><span class="comparison" id="shell_open"><span onmouseover="hoverFunction('shell_open')" onmouseout="hoverFunction('shell_open')">(visa) </span><span onmouseover="hoverFunction('shell_opencommand')" onmouseout="hoverFunction('shell_opencommand')"><span id="shell_opencommand" class="comparison">open</span></span> <span onmouseover="hoverFunction('shell_openname')" onmouseout="hoverFunction('shell_openname')"><span id="shell_openname" class="comparison">0</span></span>
<span onmouseover="hoverFunction('shell_open')" onmouseout="hoverFunction('shell_open')">ASRL3::INSTR has been opened.
You can talk to the device using "write", "read" or "query".
