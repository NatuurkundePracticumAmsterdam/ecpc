...
<span onmouseover="hoverFunction('shell_onlyopen')" onmouseout="hoverFunction('shell_onlyopen')">ASRL3::INSTR has been opened.
You can talk to the device using "write", "read" or "query".
