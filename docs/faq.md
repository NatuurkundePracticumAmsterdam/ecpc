...
Bestand: :fontawesome-regular-file-lines:`docs/index.md` en ook {{file}}`pythondaq/models/diode.py`. Die vind je ook in de repository :fontawesome-brands-github:`davidfokkema/tailor`. Folder: :fontawesome-regular-folder:`Oefenopdrachten`.
